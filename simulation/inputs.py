...
class SimulationInputs():
    ...
    def __init__(self, manager: pygame_gui.UIManager) -> None:
        ...
        self.SERVERS_LABEL = pygame_gui.elements.UILabel(relative_rect=pygame.Rect((LABELS_FROM, 150), (WIDTH, 50)), text="servidores", manager=manager, object_id="#main_label")
        self.SERVERS_INPUT = pygame_gui.elements.UITextEntryLine(relative_rect=pygame.Rect((200, 160), (WIDTH, 50)), manager=manager, object_id="#main_text_entry")
